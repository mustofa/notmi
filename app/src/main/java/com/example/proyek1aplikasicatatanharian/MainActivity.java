package com.example.proyek1aplikasicatatanharian;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Map<String, Object> data = (Map<String, Object>) parent.getAdapter().getItem(i);
    ...
    void hapusFile(String filenama){
        String path = Environment.getExternalStorageDirectory().toString() + "/kominfo.proyek1";
        File file = new File(path, filenama);
        if (file.exists()){
            file.delete();
        }
        mengambilListFilePadaFolder();
